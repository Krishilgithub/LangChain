...
template2 = PromptTemplate(
  template="You have given a list of technologies now generate 20 intermediate level mcqs from the {technologies}. Give dictionary as a output containing the question, options and answers, do not include anything else in answers like notes, comments : \n {format_instruction}",
